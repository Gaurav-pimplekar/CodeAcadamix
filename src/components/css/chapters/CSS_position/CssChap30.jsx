  ...
  return (
    <div className="p-6 bg-gray-100 rounded-lg shadow-lg">
      <h1 className="text-3xl font-bold text-blue-600 mb-4 flex items-center">
        <FaMapMarkerAlt className="mr-2" /> CSS Position - Example & Source Code
      </h1>
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-800 mt-2">
          The CSS <code>position</code> property is used to control the placement of elements on a webpage.
          It provides different positioning methods such as static, relative, absolute, fixed, and sticky.
        </p>
      </section>
      
      <section className="mb-6">
        <h2 className="text-2xl font-semibold text-gray-700 flex items-center">
          <FaCode className="mr-2 text-green-500" /> Positioning Types
        </h2>
        <ul className="list-disc list-inside text-gray-800 mt-2">
          <li><strong>Static:</strong> Default position; elements flow naturally in the document.</li>
          ...
          <li><strong>Sticky:</strong> The element toggles between relative and fixed, depending on scroll position.</li>
        </ul>
      </section>
      
      <section className="mb-6">
        <h2 className="text-2xl font-semibold text-gray-700 flex items-center">
          <FaCode className="mr-2 text-blue-500" /> Example: CSS Positioning
        </h2>
